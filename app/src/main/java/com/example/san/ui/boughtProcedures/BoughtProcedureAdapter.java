...
public class BoughtProcedureAdapter extends RecyclerView.Adapter<BoughtProcedureAdapter.Holder> {
    ...
    private BoughtProcedureFragment fragment;

    @NonNull
    @Override
    public BoughtProcedureAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BoughtProcedureAdapter.Holder holder, int position) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(holder.itemView.getContext()).setMessage("Вы хотите удалить")
                    .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int pos) {
                            viewModel.delete(boughtProcedure);
                            String message = "Процедура " + boughtProcedure.getName() + " была удалена.";
                            Toast.makeText(view.getContext(), message, Toast.LENGTH_SHORT).show();
                        }
    ...
    public void setBoughtProceduresViewModel(BoughtProcedureViewModel viewModel){
        this.viewModel = viewModel;
        notifyDataSetChanged();
    }

    public void setBoughtProceduresFragment(BoughtProcedureFragment fragment){
